...
function ProduitCommandeToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    produitCommandeSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    produitCommandeSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="produit-commande-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="produit-commande-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="produit-commande-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="produit-commande-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/produit-commande/importer">
          <button className="btn btn-primary" type="button">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=produitCommande">
...
export default ProduitCommandeToolbar;
