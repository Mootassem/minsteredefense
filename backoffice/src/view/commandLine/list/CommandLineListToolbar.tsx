...
function CommandLineToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    commandLineSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    commandLineSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="command-line-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="command-line-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="command-line-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="command-line-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=commandLine">
...
export default CommandLineToolbar;
