...
import CommandLineForm from 'src/view/commandLine/form/CommandLineForm';
import CommandLineService from 'src/modules/commandLine/commandLineService';

function CommandLineFormModal(props) {
  ...
  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await CommandLineService.create(data);
...
export default CommandLineFormModal;
