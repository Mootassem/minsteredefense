...
function HistoriquePointsToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    historiquePointsSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    historiquePointsSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="historique-points-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="historique-points-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="historique-points-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="historique-points-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/historique-points/importer">
          <button className="btn btn-primary" type="button">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=historiquePoints">
...
export default HistoriquePointsToolbar;
