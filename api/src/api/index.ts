...
require('./site').default(routes);
require('./machine').default(routes);
require('./typeMachine').default(routes);
require('./operation').default(routes);
require('./typeOperation').default(routes);
require('./emprunte').default(routes);
