...
class TenantRepository {
  ...
  static async destroy(id, options: IRepositoryOptions) {
    ...
    await Site(options.database).deleteMany({ tenant: id }, options);

    await Machine(options.database).deleteMany({ tenant: id }, options);

    await TypeMachine(options.database).deleteMany({ tenant: id }, options);

    await Operation(options.database).deleteMany({ tenant: id }, options);

    await TypeOperation(options.database).deleteMany({ tenant: id }, options);

    await Emprunte(options.database).deleteMany({ tenant: id }, options);
